...
class CustomColor {
  ...
  static Color borderColor = const Color(0xFF8D92A3);
  static Color textButton = const Color(0xFFFBF2CF);
  static Color redButton = const Color(0xFFE53935).withOpacity(0.10);
